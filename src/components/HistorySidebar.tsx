import { ChefHat, Plus, History, AlertCircle } from "lucide-react";
...
function HistorySidebar({
  ...
  return (
    <div className="w-full hidden md:w-72 bg-white border-r-2 border-orange-100 md:flex flex-col shadow-2xl flex-shrink-0">
      {/* Logo Section */}
